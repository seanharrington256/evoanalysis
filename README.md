...
- Jan 21: [Population structure in R](https://github.com/seanharrington256/evoanalysis/blob/main/Pop_structure_tutorial.Rmd). This uses the data file `/project/evoanalysis/data/petrochromis_data.vcf.gz`
